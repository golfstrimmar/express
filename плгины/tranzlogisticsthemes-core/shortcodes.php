...
function zozo_day_counter_shortcode( $atts, $content = null ) {
	...
	if( ( isset( $button_text ) && $button_text == '' ) ) {
		...
		$button_text = esc_html__('Get a discount', 'tranzlogistics');
	...
	wp_enqueue_script( 'tranzlogistics-zozo-countdown-plugin-js' );

	wp_enqueue_script( 'tranzlogistics-zozo-countdown-js' );
...
function zozo_fullwidth_box_shortcode( $atts, $content = null ) {
	...
	if( isset( $overlay ) && $overlay == 'yes' ) {
		...
		if( isset( $overlay_color ) && $overlay_color != '' ) {
			...
			$bg_color_rgb = tranzlogistics_hex2rgb( $overlay_color );
...
function zozo_sitemap_shortcode() {
	...
	$output .= '<div class="sitemap-wrapper">';
		...
		$output .= '<div class="sitemap-pages">';
			...
			$output .= '<h6 class="parallax-title text-left">'. esc_html__('Pages', 'tranzlogistics') .'</h4>';
		...
		$output .= '<div class="sitemap-categories">';
			...
			$output .= '<h6 class="parallax-title text-left">'. esc_html__('Categories', 'tranzlogistics') .'</h4>';
		...
		$output .= '<div class="sitemap-archives">';	
			...
			$output .= '<h6 class="parallax-title text-left">'. esc_html__('Archives', 'tranzlogistics') .'</h4>';
