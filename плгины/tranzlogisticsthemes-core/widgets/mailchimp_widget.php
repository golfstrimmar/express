<?php
class Tranzlogistics_Mailchimp_Form_Widget extends WP_Widget {	
	...
	{
		/* Widget settings. */
		$widget_options = array('classname' => 'zozo_mailchimp_form_widget', 'description' => esc_html__( 'Displays subscribe form for Mailchimp Lists.', 'tranzlogistics' ));
		$control_options = array('id_base' => 'zozo_mailchimp_form_widget-widget');
		
		/* Create the widget. */
		parent::__construct('zozo_mailchimp_form_widget-widget', esc_html__( 'Mailchimp Subscribe Form', 'tranzlogistics' ), $widget_options, $control_options);
	...
	function widget($args, $instance)
	{
		...
		if( $mailchimp_list != '' ) { 
			...
			$custom_msgs = '';
			$custom_msgs .= ' data-email_not_empty='. esc_html__( 'The email address is required', 'tranzlogistics' ) .'';			
			$custom_msgs .= ' data-email_valid='. esc_html__( 'The input is not a valid email address', 'tranzlogistics' ) .''; ?>
	...
	function form($instance)
	{
		...
		$lists = tranzlogistics_get_mailing_lists_format(); ?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('description') ); ?>"><?php _e('Description:', 'tranzlogistics'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('mailchimp_list') ); ?>"><?php _e( 'Choose Mailing List:', 'tranzlogistics' ); ?></label>			
...
function tranzlogistics_mailchimp_form_load()
{
	register_widget('Tranzlogistics_Mailchimp_Form_Widget');
}
add_action('widgets_init', 'tranzlogistics_mailchimp_form_load');
?>