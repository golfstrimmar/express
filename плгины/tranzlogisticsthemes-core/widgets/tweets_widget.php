...
class Zozo_Tweets_Widget extends WP_Widget {
...

	{
		...
		require_once( TRANZLOGISTICS_CORE_DIR . '/widgets/twitter-widget/twitteroauth.php' );
	...
	function tweet_time_ago( $time ) {
		...
		$periods = array( esc_html__( 'second', 'tranzlogistics' ), esc_html__( 'minute', 'tranzlogistics' ), esc_html__( 'hour', 'tranzlogistics' ), esc_html__( 'day', 'tranzlogistics' ), esc_html__( 'week', 'tranzlogistics' ), esc_html__( 'month', 'tranzlogistics' ), esc_html__( 'year', 'tranzlogistics' ), esc_html__( 'decade', 'tranzlogistics' ) );
		...
		$tense = esc_html__( 'ago', 'tranzlogistics' );
		...
		if( $difference != 1 ) {
			...
			$periods[$j] .= esc_html__( 's', 'tranzlogistics' );
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('twitter_id') ); ?>"><?php _e('Twitter ID:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('consumer_key') ); ?>"><?php _e('Consumer Key:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('consumer_secret') ); ?>"><?php _e('Consumer Secret:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('access_token') ); ?>"><?php _e('Access Token:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('access_token_secret') ); ?>"><?php _e('Access Token Secret:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tweet_count') ); ?>"><?php _e('Number of Tweets:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tweet_visible') ); ?>"><?php _e('Number of Visible Tweets:', 'tranzlogistics'); ?></label>
