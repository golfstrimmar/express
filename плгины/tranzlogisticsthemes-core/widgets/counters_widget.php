...
class Tranzlogistics_Counters_Widget extends WP_Widget {
	...
	{			
		...
		$widget_options = array('classname' => 'zozo_counters_widget', 'description' => esc_html__( 'Display counters.', 'tranzlogistics' ));
		...
		parent::__construct('zozo_counters_widget-widget', esc_html__( 'Counters', 'tranzlogistics' ), $widget_options, $control_options);
...

	{
		...
		$counter_label_1 = !empty($instance['counter_label_1']) ? $instance['counter_label_1'] : esc_html__('Total Downloads : ', 'tranzlogistics' );

		$counter_value_1 = $instance['counter_value_1'];

		$counter_label_2 = !empty($instance['counter_label_2']) ? $instance['counter_label_2'] : esc_html__('Happy Clients : ', 'tranzlogistics' );
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('counter_label_1') ); ?>"><?php _e('Counter Label 1:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('counter_value_1') ); ?>"><?php _e('Counter Value 1:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('counter_label_2') ); ?>"><?php _e('Counter Label 2:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('counter_value_2') ); ?>"><?php _e('Counter Value 2:', 'tranzlogistics'); ?></label>
...
function tranzlogistics_counters_load()

{

	register_widget('Tranzlogistics_Counters_Widget');

}



add_action('widgets_init', 'tranzlogistics_counters_load');
