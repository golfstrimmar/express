...
class Tranzlogistics_Tabs_Widget extends WP_Widget {
...

	{
		...
		$widget_options = array('classname' => 'zozo_tabs_widget', 'description' => esc_html__( 'Displays popular posts, recent posts and comments in tabs.', 'tranzlogistics' ));
		...
		parent::__construct('zozo_tabs-widget', esc_html__( 'Tabs', 'tranzlogistics' ), $widget_options, $control_options);
			...
			<div class="zozo-tabs-wrapper tabs">
				...
				<ul id="zozo-tabs" class="nav nav-tabs" role="tablist">
					...
					<?php if($show_popular_posts == 'on') { ?>
						...
						<li class="active"><h6><a href="#tab-popular" data-toggle="tab"><?php _e('Popular', 'tranzlogistics'); ?></a></h6></li>

					<?php } ?>

					<?php if($show_recent_posts == 'on') { ?>

						<li><h6><a href="#tab-recent" data-toggle="tab"><?php _e('Recent', 'tranzlogistics'); ?></a></h6></li>
									...
									<li>
										...
										<div class="widget-entry-content">
											...
											<div class="widget-entry-meta">
												...
												<span class="entry-date"><?php the_time( tranzlogistics_get_theme_option( 'zozo_blog_date_format' ) ); ?></span>
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_popular_posts') ); ?>"><?php _e('Show Popular Posts', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_recent_posts') ); ?>"><?php _e('Show Recent Posts', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_comments') ); ?>"><?php _e('Show Comments', 'tranzlogistics'); ?></label>

		</p>

		<p>

			<label for="<?php echo esc_attr( $this->get_field_id('posts_count') ); ?>"><?php _e('Number of popular posts:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('recent_posts') ); ?>"><?php _e('Number of recent posts:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('comments_count') ); ?>"><?php _e('Number of comments:', 'tranzlogistics'); ?></label>
...
function tranzlogistics_tabs_load()

{

	register_widget('Tranzlogistics_Tabs_Widget');

}



add_action('widgets_init', 'tranzlogistics_tabs_load');