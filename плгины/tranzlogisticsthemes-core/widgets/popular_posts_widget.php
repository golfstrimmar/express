...
class Tranzlogistics_Popular_Posts_Widget extends WP_Widget {
...

	{
		...
		$widget_options = array('classname' => 'zozo_popular_posts_widget', 'description' => esc_html__( 'Displays latest posts based on categories.', 'tranzlogistics' ));
		...
		parent::__construct('zozo_popular_posts-widget', esc_html__( 'Popular Posts', 'tranzlogistics' ), $widget_options, $control_options);
...

	{
						...
						<div class="latest-post-content">
							...
							<?php if( $show_excerpt == 'on' ) { ?>
								...
								<div class="entry-summary">
									...
									<p><?php echo tranzlogistics_shortcode_stripped_excerpt( get_the_content(), 10 ); ?></p>
							...
							<?php if( $show_date == 'on' ) { ?>
								...
								<div class="entry-date posted-date"><i class="simple-icon icon-calendar"></i> <?php the_time( tranzlogistics_get_theme_option( 'zozo_blog_date_format' ) ); ?></div>
		...
		echo wp_kses( $after_widget, tranzlogistics_expanded_allowed_tags() );
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('categories') ); ?>"><?php _e('Choose Category:', 'tranzlogistics'); ?></label>			

			<?php $args = array(

					'show_option_all'    => esc_html__( 'All Categories', 'tranzlogistics' ),
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('posts_count') ); ?>"><?php _e('Number of posts to show:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_date') ); ?>"><?php _e('Show Date', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_excerpt') ); ?>"><?php _e('Show Excerpt', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_thumb') ); ?>"><?php _e('Show Thumbnail Image', 'tranzlogistics'); ?></label>
...
function tranzlogistics_popular_posts_load()

{

	register_widget('Tranzlogistics_Popular_Posts_Widget');

}



add_action('widgets_init', 'tranzlogistics_popular_posts_load');