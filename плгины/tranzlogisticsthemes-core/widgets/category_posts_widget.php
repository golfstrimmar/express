...
class Tranzlogistics_Category_Posts_Widget extends WP_Widget {
...

	{
		...
		$widget_options = array('classname' => 'zozo_category_posts_widget', 'description' => esc_html__( 'Displays category posts.', 'tranzlogistics' ));
		...
		parent::__construct('zozo_category_posts-widget', esc_html__( 'Category Posts', 'tranzlogistics' ), $widget_options, $control_options);
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_button') ); ?>"><?php _e('Show Button', 'tranzlogistics'); ?></label>

		</p>

		<p>

			<label for="<?php echo esc_attr( $this->get_field_id('button_text') ); ?>"><?php _e('Button Text:', 'tranzlogistics'); ?></label>
...
function tranzlogistics_category_posts_load()

{

	register_widget('Tranzlogistics_Category_Posts_Widget');

}



add_action('widgets_init', 'tranzlogistics_category_posts_load');
