...
class Tranzlogistics_Social_Link_Widget extends WP_Widget {
	...
	{				
		...
		$widget_options = array('classname' => 'zozo_social_link_widget', 'description' => esc_html__( 'Display your social links.', 'tranzlogistics' ));
		...
		parent::__construct('zozo_social_link_widget-widget', esc_html__( 'Social Links', 'tranzlogistics' ), $widget_options, $control_options);
...

	{
		...
		echo wp_kses( $before_widget, tranzlogistics_expanded_allowed_tags() );

		

		if($title) {

			echo wp_kses( $before_title . $title . $after_title, tranzlogistics_expanded_allowed_tags() );
		...
		<?php echo wp_kses( $after_widget, tranzlogistics_expanded_allowed_tags() );
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><?php _e('Title:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('align') ); ?>"><?php _e('Alignment:', 'tranzlogistics'); ?></label>
			...
			<select id="<?php echo esc_attr( $this->get_field_id('align' )); ?>" name="<?php echo esc_attr( $this->get_field_name('align') ); ?>" class="widefat" style="width:100%;">
				...
				<option value="left" <?php echo selected(esc_attr($instance['align']), 'left', false); ?>><?php _e('Left', 'tranzlogistics'); ?></option>

				<option value="right" <?php echo selected(esc_attr($instance['align']), 'right', false); ?>><?php _e('Right', 'tranzlogistics'); ?></option>

				<option value="center" <?php echo selected(esc_attr($instance['align']), 'center', false); ?>><?php _e('Center', 'tranzlogistics'); ?></option>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('icon_size') ); ?>"><?php _e('Icon Size:', 'tranzlogistics'); ?></label>
			...
			<select id="<?php echo esc_attr( $this->get_field_id('icon_size' )); ?>" name="<?php echo esc_attr( $this->get_field_name('icon_size') ); ?>" class="widefat" style="width:100%;">
				...
				<option value="normal" <?php echo selected(esc_attr($instance['icon_size']), 'normal', false); ?>><?php _e('Normal', 'tranzlogistics'); ?></option>

				<option value="large" <?php echo selected(esc_attr($instance['icon_size']), 'large', false); ?>><?php _e('Large', 'tranzlogistics'); ?></option>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('icon_type') ); ?>"><?php _e('Icon Type:', 'tranzlogistics'); ?></label>
			...
			<select id="<?php echo esc_attr( $this->get_field_id('icon_type' )); ?>" name="<?php echo esc_attr( $this->get_field_name('icon_type') ); ?>" class="widefat" style="width:100%;">
				...
				<option value="circle" <?php echo selected(esc_attr($instance['icon_type']), 'circle', false); ?>><?php _e('Circle', 'tranzlogistics'); ?></option>

				<option value="square" <?php echo selected(esc_attr($instance['icon_type']), 'square', false); ?>><?php _e('Square', 'tranzlogistics'); ?></option>

				<option value="rounded" <?php echo selected(esc_attr($instance['icon_type']), 'rounded', false); ?>><?php _e('Rounded', 'tranzlogistics'); ?></option>

				<option value="transparent" <?php echo selected(esc_attr($instance['icon_type']), 'transparent', false); ?>><?php _e('Transparent', 'tranzlogistics'); ?></option>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('facebook') ); ?>"><?php _e('Facebook URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>"><?php _e('Twitter URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('pinterest') ); ?>"><?php _e('Pinterest URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('googleplus') ); ?>"><?php _e('Google Plus URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('linkedin') ); ?>"><?php _e('Linkedin URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('youtube') ); ?>"><?php _e('Youtube URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('rss') ); ?>"><?php _e('Rss URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tumblr') ); ?>"><?php _e('Tumblr URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('dribbble') ); ?>"><?php _e('Dribbble URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('flickr') ); ?>"><?php _e('Flickr URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('instagram') ); ?>"><?php _e('Instagram URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('vimeo') ); ?>"><?php _e('Vimeo URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('skype') ); ?>"><?php _e('Skype URL:', 'tranzlogistics'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('yahoo') ); ?>"><?php _e('Yahoo URL:', 'tranzlogistics'); ?></label>
...
function tranzlogistics_social_link_load()

{

	register_widget('Tranzlogistics_Social_Link_Widget');

}



add_action('widgets_init', 'tranzlogistics_social_link_load');
