...
class GP_Field_Nested_Form extends GF_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		$add_button_label = sprintf( __( 'Pridėti siuntinį', 'gp-nested-forms' ), $this->get_item_label() );
		...
		$args = array(
			...
			'labels'             => array(
				...
				'edit_entry'      => __( 'Koreguoti', 'gp-nested-forms' ),
				'duplicate_entry' => __( 'Dublikuoti', 'gp-nested-forms' ),
				'delete_entry'    => __( 'Ištrinti', 'gp-nested-forms' ),
			),
		);
